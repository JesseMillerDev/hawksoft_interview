            ...
            if (!_context.Contacts.Any())
            {
                _context.Contacts.AddRange(
                        new Contact
                        {
                            UserId = Guid.NewGuid(),
                            Name = "Bob Lawblaw",
                            Email = "bob@lawblaw.com",
                            Address = new Address { Street = "1st Street", Number = "111", City = "Portland", Country = "USA", Zip = "98682" }
                        ...
                        new Contact
                        {
                            ...
                            Name = "John Cena",
                            Email = "john@cena.com",
                            Address = new Address { Street = "2nd Street", Number = "222", City = "Portland", Country = "USA", Zip = "98682" }
                        }
                ); ;
            }
